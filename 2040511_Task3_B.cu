...
//compile with: nvcc 2040511_Task3_B.cu lodepng.cpp -o 2040511_Task3_B

__global__ void gaussianBlur(unsigned char * gpu_imageOuput, unsigned char * gpu_imageInput,unsigned int width,unsigned int height)
{
	int r = 0;
		int g = 0;
		int b = 0;
...
int main(int argc, char **argv){
	...
	// launch the kernel
	gaussianBlur<<<height, width>>>(d_out, d_in, width,height);
